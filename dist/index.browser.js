          ...
          function(module2, exports2, __webpack_require__) {
            (function(Buffer2, global2, module3, process2) {
              ...
              Object.keys(fsProto).forEach(function(key) {
                if (typeof fs2[key] === "function") {
                  _fsMock[key] = function() {
                    return fs2[key].apply(fs2, arguments);
                  };
                } else {
                  _fsMock[key] = fs2[key];
                }
              ...
              function mkdirpSync(p, mode, fs3) {
                if (!fs3.existsSync(p)) {
                  mkdirpSync(path.dirname(p), mode, fs3);
              ...
              var BFSEmscriptenStreamOps = function BFSEmscriptenStreamOps2(fs3) {
                this.fs = fs3;
                this.nodefs = fs3.getNodeFS();
                this.FS = fs3.getFS();
                this.PATH = fs3.getPATH();
                this.ERRNO_CODES = fs3.getERRNO_CODES();
              };
              ...
              var BFSEmscriptenNodeOps = function BFSEmscriptenNodeOps2(fs3) {
                this.fs = fs3;
                this.nodefs = fs3.getNodeFS();
                this.FS = fs3.getFS();
                this.PATH = fs3.getPATH();
              ...
              var MirrorFile = function(PreloadFile$$1) {
                function MirrorFile2(fs3, path$$1, flag, stat, data) {
                  PreloadFile$$1.call(this, fs3, path$$1, flag, stat, data);
                }
                if (PreloadFile$$1)
              ...
              var AsyncMirror = function(SynchronousFileSystem$$1) {
                ...
                AsyncMirror2.Create = function Create(opts, cb) {
                  try {
                    var fs3 = new AsyncMirror2(opts.sync, opts.async, false);
                    fs3.initialize(function(e) {
                      if (e) {
                        cb(e);
                      } else {
                        cb(null, fs3);
              ...
              var HTML5FSFile = function(PreloadFile$$1) {
                function HTML5FSFile2(fs3, entry, path$$1, flag, stat, contents) {
                  PreloadFile$$1.call(this, fs3, path$$1, flag, stat, contents);
                  this._entry = entry;
                }
                if (PreloadFile$$1)
              ...
              var HTML5FS = function(BaseFileSystem$$1) {
                ...
                HTML5FS2.Create = function Create(opts, cb) {
                  var fs3 = new HTML5FS2(opts.size, opts.type, false);
                  fs3.allocate(function(e) {
                    return e ? cb(e) : cb(null, fs3);
                  }, false);
                };
              ...
              var AsyncKeyValueFileSystem = function(BaseFileSystem$$1) {
                ...
                AsyncKeyValueFileSystem2.prototype.init = function init2(store, cb) {
                  this.store = store;
              ...
              var MountableFileSystem = function(BaseFileSystem$$1) {
                ...
                MountableFileSystem2.Create = function Create(opts, cb) {
                  var fs3 = new MountableFileSystem2();
                  Object.keys(opts).forEach(function(mountPoint) {
                    fs3.mount(mountPoint, opts[mountPoint]);
                  });
                  cb(null, fs3);
                };
                ...
                MountableFileSystem2.prototype.mount = function mount(mountPoint, fs3) {
                  if (mountPoint[0] !== "/") {
              ...
              var LockedFS = function LockedFS2(fs3) {
                this._fs = fs3;
                this._mu = new Mutex();
              };
              ...
              var OverlayFile = function(PreloadFile$$1) {
                function OverlayFile2(fs3, path$$1, flag, stats, data) {
                  PreloadFile$$1.call(this, fs3, path$$1, flag, stats, data);
                }
                if (PreloadFile$$1)
              ...
              var OverlayFS = function(LockedFS$$1) {
                ...
                OverlayFS2.Create = function Create(opts, cb) {
                  try {
                    var fs3 = new OverlayFS2(opts.writable, opts.readable, false);
                    fs3.initialize(function(e) {
                      cb(e, fs3);
                    }, false);
                  } catch (e) {
              ...
              var WorkerFS = function(BaseFileSystem$$1) {
                ...
                WorkerFS2.Create = function Create(opts, cb) {
                  var fs3 = new WorkerFS2(opts.worker, false);
                  fs3.initialize(function() {
                    cb(null, fs3);
                  });
                };
                ...
                ZipFS2.Create = function Create(opts, cb) {
                  try {
                    ZipFS2.computeIndex(opts.zipData, function(zipTOC) {
                      var fs3 = new ZipFS2(zipTOC, opts.name, false);
                      cb(null, fs3);
                    }, false);
                  } catch (e) {
                    cb(e);
              ...
              var IsoFS = function(SynchronousFileSystem$$1) {
                ...
                IsoFS2.Create = function Create(opts, cb) {
                  ...
                  var e;
                  try {
                    fs3 = new IsoFS2(opts.data, opts.name, false);
                  } catch (e2) {
                    e2 = e2;
                  } finally {
                    cb(e, fs3);
              ...
              function registerFileSystem(name, fs3) {
                Backends[name] = fs3;
              }
              ...
              function configure(config, cb) {
                getFileSystem(config, function(e, fs3) {
                  if (fs3) {
                    initialize(fs3);
                    cb();
                  } else {
                ...
                if (options !== null && typeof options === "object") {
                  ...
                  props.forEach(function(p) {
                    ...
                    if (d !== null && typeof d === "object" && d["fs"]) {
                      waitCount++;
                      getFileSystem(d, function(e, fs3) {
                        waitCount--;
                        if (e) {
                          if (called) {
                            return;
...
var wasmFile = "./main.wasm";
globalThis.require = __require;
globalThis.fs = require_browserfs();
globalThis.TextEncoder = require_util().TextEncoder;
globalThis.TextDecoder = require_util().TextDecoder;
(void 0).require = __require;
(void 0).fs = require_browserfs();
(void 0).TextEncoder = require_util().TextEncoder;
(void 0).TextDecoder = require_util().TextDecoder;
(void 0).fs = require_browserfs();
var wasmExec = require_wasm_exec();
async function init() {
  const go = new Go();
